...
if info:
    ...
    # 설명 박스 (하나로 통합)
    st.markdown("""
    <div style="background-color:#f8f9fa; padding:30px; border-radius:12px; border-left:5px solid #1f77b4; color: black;">
        <h4>1️⃣ Job-Bu 페이지 (기업 추천형 챗봇)</h4>
        <ul>
            <li>📋 사이드바에서 <strong>사용자 프로필</strong>을 입력하세요.</li>
            <li>❓ 원하는 기업 조건을 입력하고 <strong>질문 실행</strong> 버튼을 눌러주세요.</li>
            <li>📁 결과는 3개의 탭으로 구성됩니다:
                <ul>
                    <li>✅ <strong>Job-Bu 답변</strong>: 추천 요약</li>
                    <li>📚 <strong>추천 기업 상세</strong>: 상세 기업 정보</li>
                    <li>🌍 <strong>추천 기업 위치</strong>: 지도에 시각화</li>
                    <li>🔍 <strong>부산 기업 분포</strong>: 규모 있는 전체 기업 맵</li>
                </ul>
            </li>
        </ul>
        ...
        <ul>
            <li>🤖 추천 이후, 추가적으로 궁금한 내용을 질문할 수 있습니다.</li>
            <li>📝 입력된 프로필 + 참고 문서를 바탕으로 답변합니다.</li>
            <li>💡 예시 질문:
                <ul>
                    <li style="color:green;">"복지제도는 어떻게 되나요?"</li>
    ...
    <div style='text-align: center;'>
        <h4>📌 지역 특화 일자리 상담 흐름</h4>
        <img src='https://raw.githubusercontent.com/seungcheoll/busan/main/chatbot.png' 
             style='width: 85%; max-width: 800px; height: auto; margin-top: 10px;'/>
    </div>
    """, unsafe_allow_html=True)
# ───────────────────────────────────────────
